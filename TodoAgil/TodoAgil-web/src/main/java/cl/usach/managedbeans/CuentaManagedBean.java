    ...
    public void nuevaCuenta(){
        ...
        if("Trello".equals(tipoC.getNombreTipoCuenta())){
            if(tableroTrello.checkCuenta(cuenta)){
                ...
                FacesMessage msg = new FacesMessage("Cuenta No Agregada","Verificar el usuario, key, secret y token de la cuenta.");  
                FacesContext.getCurrentInstance().addMessage(null, msg);
            }
        }else{
            if(tableroKanbanize.checkCuenta(cuenta)){
               ...
               FacesContext.getCurrentInstance().addMessage(null, msg); 
                ...
                FacesMessage msg = new FacesMessage("Cuenta No Agregada","Verificar el usuario y key.");  
                FacesContext.getCurrentInstance().addMessage(null, msg);
            }
        }
        limpiar();
