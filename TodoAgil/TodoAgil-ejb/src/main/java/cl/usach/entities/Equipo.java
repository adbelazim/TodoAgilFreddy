...
@NamedQueries({
    ...
    @NamedQuery(name = "Equipo.findUsuariosBySprintGrupo", query = "SELECT e.idCuenta.idUsuario FROM Equipo e WHERE e.idTablero.idSprintGrupo = :idSprintGrupo GROUP BY e.idCuenta.idUsuario")
})
