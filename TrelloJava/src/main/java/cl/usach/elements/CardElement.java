...
public class CardElement{
     ...
     * @param url
     */
    public CardElement(String id, String checkItemStates, Boolean closed, String dateLastActivity, String desc, String descData, String idBoard, String idList, String idMembersVoted, String idShort, String idAttachmentCover, Boolean manualCoverAttachment, String name, String pos, String shortLink, String badges, String due, String idChecklists, String idMembers, String labels, String shortUrl, Boolean subscribed, String url) {
        this.id = id;
     ...
     */
    public CardElement(JSONObject jsonO) throws JSONException{
        ...
        if(!jsonO.isNull("dateLastActivity")) this.dateLastActivity = jsonO.get("dateLastActivity").toString();
        ...
        if(!jsonO.isNull("due")) this.due = jsonO.get("due").toString(); 
