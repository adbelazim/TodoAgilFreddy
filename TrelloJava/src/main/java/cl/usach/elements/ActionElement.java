...
public class ActionElement{
     ...
     */
    public ActionElement(String id, String idMemberCreator, String nameListAfter, String idListAfter, String nameListBefore, String idListBefore, String boardName, String boardId, String boardShortLink, String cardShortLink, String cardIdShort, String cardName, String cardId, String cardDue, String type, String date, String memberCreatorId, String memberCreatorFullName, String memberCreatorInitials, String memberCreatorUsername, String memberId, String memberAvatarHash, String memberFullName, String memberInitials, String memberUsername) {
        this.id = id;
     ...
     */
    public ActionElement(JSONObject json) throws JSONException{
        ...
        if(!json.isNull("data")){
            if(!json.getJSONObject("data").isNull("listAfter")){
                if(!json.getJSONObject("data").getJSONObject("listAfter").isNull("name")){ 
                    this.nameListAfter = rt.formatString(json.getJSONObject("data").getJSONObject("listAfter").get("name").toString());
                }
            ...
            if(!json.getJSONObject("data").isNull("listBefore")){
                if(!json.getJSONObject("data").getJSONObject("listBefore").isNull("name")){ 
                    this.nameListBefore = rt.formatString(json.getJSONObject("data").getJSONObject("listBefore").get("name").toString());
                }
            ...
            if(!json.getJSONObject("data").isNull("board")){
                if(!json.getJSONObject("data").getJSONObject("board").isNull("name")){ 
                    this.boardName = rt.formatString(json.getJSONObject("data").getJSONObject("board").get("name").toString());
            ...
            if(!json.getJSONObject("data").isNull("card")){
                ...
                if(!json.getJSONObject("data").getJSONObject("card").isNull("name")) 
                    this.cardName = rt.formatString(json.getJSONObject("data").getJSONObject("card").get("name").toString());
                ...
                if(!json.getJSONObject("data").getJSONObject("card").isNull("due")) 
                    this.cardDue = json.getJSONObject("data").getJSONObject("card").get("due").toString();
            }
        }
        if(!json.isNull("type")) this.type = json.get("type").toString();
        if(!json.isNull("date")) this.date = json.get("date").toString();
        if(!json.isNull("memberCreator")){
            ...
            if(!json.getJSONObject("memberCreator").isNull("fullName")) 
                this.memberCreatorFullName = rt.formatString(json.getJSONObject("memberCreator").get("fullName").toString());
        ...
        if(!json.isNull("member")){
            ...
            if(!json.getJSONObject("member").isNull("fullName")) 
               this.memberFullName = rt.formatString(json.getJSONObject("member").get("fullName").toString());
     ...
     * @param cardDue
     */
    public void setCardDue(String cardDue) {
        this.cardDue = cardDue;
    }
